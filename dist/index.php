                ...
                <div class=" col-lg-6">
                    <div class="img__left">
                        ...
                        <div class="coment__tittel">
                            ...
                            <hr class="line">
                            <p>
                                Bệnh viện quốc tế Minh Anh được xây dựng và quản lý theo mô hình bệnh viện tiên tiến.
                                Bên cạnh cơ sở vật chất khang trang, tiện nghi cao cấp, trang thiết bị y tế hiện đại,
                                không gian
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="heart__slide">
                        ...
                        <div class="owl-carousel slide__cmt">
                            <div class="item">
                                ...
                                <h4 class="author"><b>Thủy Nguyễn</b><br>
                                    " Đến từ Mỹ Tho, Tiền Giang "</h4>
                            </div>
                            <div class="item">
                                <p>Chăm sóc rất chu đáo và tận tình .. từ bác sĩ y tá .. lao công ai củng zui ze lịch sự
                                    .. đúng là bỏ tiền ra rất xứng đáng.. rất rất hài lòng</p>
    ...
    <div class="frame__cart">
        <div class="cart">
            <div class="left__cmt">
                ...
                <h4>
                    Bệnh viện hạnh phúc của người bệnh
                </h4>
                <hr class="line">
                <p>Ra đời vào tháng 9 năm 2000, Bệnh viện Hồng Đức có thể nói là một trong những nơi khám chữa bệnh uy
        ...
        <!-- end cart -->
        <div class="pink__box"></div>
        <div class="pink__box_2"></div>
    </div>
    <!-- end frame__cart -->


    <div class="doctor__member">
        <div class="text_content">
            <div class="text">
                <p>Đội ngũ Y bác sĩ</p>
                <hr class="line">
            </div>
        </div>
        <!-- end text__content -->
